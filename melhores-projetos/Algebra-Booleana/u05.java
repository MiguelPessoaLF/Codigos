public class u05
{
    ...
    public static void main (String zzz[])
    {
        ...
        char[] linha = linhas.toCharArray();//transforma em um array para mais facil manipulação
        ...
        u05 objm = new u05();//cria o objeto main
        ...
        for (int z = j - 1;z >= 0;z--)//le o array de inteiros, verifica os dados, e do final para o inicio,
        //manipula os dados, chamando as funçoes case como verificaçao
        {
            if (intl[z] == 2 && (isB_case1(intl,z)))
            {
                intl[z] = 1;
                intl = Cut (intl,z + 1);
            }
            else if (intl[z] == 2 && !(isB_case1(intl,z)))
            {
                intl[z] = 0;
                intl = Cut (intl,z + 1);
            }
            if (intl[z] == 3)
            {
                if (isB_case2(intl,z + 1))
                {
                    intl[z] = 1;
                    intl = Cut (intl,z + 1);
                }
                else if (!isB_case2(intl,z + 1))
                {
                    intl[z] = 0;
                    intl = Cut (intl,z + 1);
                }
            }
            if (intl[z] == 4 && (isB_case3(intl,j,z)))
            {
                intl[z] = 1;
                intl = Cut (intl,z + 1);
            }
            else if (intl[z] == 4 && !(isB_case3(intl,j,z)))
            {
                intl[z] = 0;
                intl = Cut (intl,z + 1);
            }
        }
        MyIO.print(intl[0]);//no final da manipulaçao, o resultado da função vai estar na primeira casa,
